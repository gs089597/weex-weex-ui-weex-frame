...
<template>
    <div class="wxc-tab-page"
        ...
        <scroller class="tab-title-list"
                  ...
                  :data-spm="spmC"
                  :style="{ backgroundColor: tabStyles.bgColor, paddingLeft:tabStyles.leftOffset+'px' }">
            ...
            <div class="title-item"
                ...
                <image class="title-icon" :src="currentPage == index ? v.activeIcon : v.icon"
                       v-if="titleType == 'icon' && !titleUseSlot"></image>
                <text
                        v-if="!titleUseSlot"
                        :style="{fontWeight: (currentPage == index && tabStyles.isActiveTitleBold)? 'bold' : 'normal', color: currentPage == index ? tabStyles.activeTitleColor : tabStyles.titleColor, paddingLeft:tabStyles.textPaddingLeft+'px', paddingRight:tabStyles.textPaddingRight+'px'}"
                        class="tab-text">{{v.title}}</text>
                <div class="border-bottom"
                     v-if="tabStyles.hasActiveBottom && !titleUseSlot"
                     :style="{backgroundColor: currentPage == index ? tabStyles.activeBottomColor : 'transparent' }"></div>
